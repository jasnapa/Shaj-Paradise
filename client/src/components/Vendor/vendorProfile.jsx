...
import { editProfile } from "../../Services/vendorApi";
                ...
                <table className="text-xs my-3">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="px-2 py-2">{vendorProfile.mobile}</td>
                    </tr>
                    <tr>
                      <td className="px-2 py-2 text-gray-500 font-semibold">
                        Email
                      </td>
                      <td className="px-2 py-2">{vendorProfile.email}</td>
                    </tr>
                  </tbody>
                </table>
